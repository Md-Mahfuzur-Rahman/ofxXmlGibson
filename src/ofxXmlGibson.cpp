...
GibsonLayer::GibsonLayer(ofxXmlSettings* xmlParser, int which, string imageSearchDir) {
...
void GibsonLayer::startTimer() {
    milliStartTime = ofGetElapsedTimeMillis();
}

int GibsonLayer::findTimeArrayIndex() {
...
ofxXmlGibson::ofxXmlGibson(string xmlPath, string searchDir) {
...
GibsonLayer* ofxXmlGibson::getLayerByFileName(string filename) {
